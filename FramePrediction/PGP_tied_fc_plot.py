...
load_datetime = "2018-11-28 09:36:32"#"2018-11-23 10:46:04"#"2018-11-23 10:45:53"#
load_epoch = 25
input_length = 2
batch_size = 10
...
loader = Logger("{}_n_{}_{}_share_u_{}_w_{}".format(dataset_name,n,model_name,share_U,share_W),use_csv=False)
...
for i in range(200):
	...
	plt.imshow(model.u1_t.weight[:,i].view(image_shape[0],image_shape[1]).cpu().detach().numpy())
	plt.axis('off')
	plt.tick_params(axis='both',which='both',bottom=False,top=False,left=False,right=False,labelbottom=False,labelleft=False)
plt.suptitle("weights u1_t")
plt.savefig('output/{}_n_{}_{}/epoch_{}/u1_t_shared_{}.png'.format(dataset_name,n,model_name,load_epoch,share_U),dpi=600)
...
plt.savefig('output/{}_n_{}_{}/epoch_{}/u1_prime_shared_{}.png'.format(dataset_name,n,model_name,load_epoch,share_V),dpi=600)
